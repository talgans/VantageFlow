...
export const TeamIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.51.056 1.02.083 1.53.083h1.5a4.5 4.5 0 0 0 4.5-4.5V7.5a3 3 0 0 0-3-3h-1.5a3 3 0 0 0-3 3v.75m-7.5 2.962c.51.056 1.02.083 1.53.083h1.5a4.5 4.5 0 0 0 4.5-4.5V7.5a3 3 0 0 0-3-3h-1.5a3 3 0 0 0-3 3v.75m0 13.5c-.51-.056-1.02-.083-1.53-.083H4.5a4.5 4.5 0 0 1-4.5-4.5v-1.5a3 3 0 0 1 3-3h1.5a3 3 0 0 1 3 3v1.5m0 0h1.5a4.5 4.5 0 0 0 4.5-4.5v-1.5a3 3 0 0 0-3-3h-1.5a3 3 0 0 0-3 3v.75" />
    </svg>
);
...
export const TrophyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172V9.496c0-.779-.635-1.409-1.418-1.409h-2.195c-.783 0-1.418.63-1.418 1.409v6.857c0 1.155-.353 2.23-1 3.125m9.982 0a9.04 9.04 0 0 1-1.009 3.172m-13.483 0a9.04 9.04 0 0 1-1.009-3.172m0 0V9.307C4.197 6.755 6.258 4.5 8.98 4.5h6.04c2.723 0 4.783 2.255 4.783 4.807v6.685" />
    </svg>
);
...
export const PresentationChartLineIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0H16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 14.25 16.5h-2.25m-12 0h12m-12 0h-1.5m1.5 0v2.25h1.5m13.5-2.25h-1.5m1.5 0v2.25H21M6.75 12a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3ZM16.5 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3ZM12 9a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
    </svg>
);
...
export const PhotoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 0 3ZM8.25 6.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
    </svg>
);
